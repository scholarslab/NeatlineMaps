...
<div id="primary">
    ...
    <p id="add-item" class="add-button"><a class="add" href="<?php echo html_escape(uri('neatline-maps/namespaces/create')); ?>">Add Namespace</a></p>
                ...
                <tbody>
                    <?php foreach ($namespaces as $namespace): ?>
                        <tr>
                            ...
                            <td width="100">
                                <a href="<?php echo $namespace->getServer()->url; ?>"><?php echo $namespace->getServer()->name; ?></a>
                            </td>
